...
public class Conversation implements Persistable{
    ...
    // Ordering by the latest lastMessageSentTimestamp while having conversationID as a tiebreaker to avoid merging 
